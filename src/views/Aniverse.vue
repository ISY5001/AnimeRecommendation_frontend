...
.styled-title {
  ...
  color: transparent;  /* 浅色文字 */
  
  text-shadow: 2px 2px 2px #999;  /* 文字阴影效果 */
  font-family: 'VT323', cursive;  /* 艺术字体，需要确保用户的设备上有这个字体，或者你可以使用 Google Fonts 或其他字体服务 */
  font-size: 80px;  /* 调整字体大小 */
  display: inline-block;  /* 这是为了使 transform 属性有效 */
  animation: swing 1s 5 alternate;  /* 让动画播放五次 */
  transform-origin: center bottom;  /* 设置旋转点为文本的底部中心 */
}
</style>
...
.styled-title2 {
  color: #ccc;  /* 浅色文字 */
  text-shadow: 2px 2px 2px #999;  /* 文字阴影效果 */
  font-family: 'Maven Pro', cursive;  /* 艺术字体，需要确保用户的设备上有这个字体，或者你可以使用 Google Fonts 或其他字体服务 */
...
<style scoped>
.custom-file-upload {
  background-color: #000000; /* 你可以设置为你希望的任何颜色 */
  color: rgb(193, 193, 193); /* 根据背景颜色更改文字颜色以确保可读性 */
  border: none; /* 可选：移除边框 */
  transition: background-color 0.3s ease; /* 可选：添加过渡效果 */
}

.custom-file-upload:hover {
  background-color: #ee2fe5; /* 可选：更改鼠标悬停时的背景颜色 */
}
</style>
<style scoped>
.paprika-style-btn {
  background-color: #00d03e; /* Paprika Style 按钮的背景颜色 */
  color: white; /* 文字颜色 */
}

.hayao-style-btn {
  background-color: #c50606; /* Hayao Style 按钮的背景颜色 */
  color: white; /* 文字颜色 */
}

.shinkai-style-btn {
  background-color: #0707dd; /* Shinkai Style 按钮的背景颜色 */
  color: white; /* 文字颜色 */
}
